...
function Information() {
  ...
  return (
    <div
      className={`h-fit m-8 p-2 rounded-2xl transition-all duration-300 ease-in-out ${
        enableEdit ? "outline-2 bg-gray-700" : "bg-gray-500"
      }`}
    >
      <div
        className="size-10 absolute -translate-y-5 translate-x-80 z-50 rounded-2xl bg-white"
